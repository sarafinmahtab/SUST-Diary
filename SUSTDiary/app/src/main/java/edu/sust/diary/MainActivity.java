...
import edu.sust.diary.fragments.AboutFragment;
import edu.sust.diary.fragments.AdministrationFragment;
import edu.sust.diary.fragments.DepartmentFragment;
import edu.sust.diary.fragments.HolidayFragment;
import edu.sust.diary.fragments.InstituteAndCenterFragment;
import edu.sust.diary.fragments.LocationFragment;
import edu.sust.diary.fragments.OfficeFragment;
...
//        View navHeaderView = navigationView.getHeaderView(0);
    ...
    private void extractJsonDataToRealm() {
        ...
        realm.executeTransaction(realm1 -> {
            try {
                inputStream = assetManager.open("schools.json");
...
//                Log.d("json", json);
                ...
                realm1.createOrUpdateObjectFromJson(SchoolsOfDepartments.class, inputStream);
