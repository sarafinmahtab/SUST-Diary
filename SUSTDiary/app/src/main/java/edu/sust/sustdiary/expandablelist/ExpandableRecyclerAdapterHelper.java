package edu.sust.sustdiary.expandablelist;
 ...
 */
class ExpandableRecyclerAdapterHelper {
     ...
     */
    static List<Object> generateParentChildItemList(List<? extends ParentListItem> parentItemList) {
